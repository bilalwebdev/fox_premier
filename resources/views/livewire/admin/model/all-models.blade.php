<div>
    <div class="flex justify-center mb-5">
        <p class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">All Listings</p>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-end">
                            <a href="{{ route('admin.model.edit', $model->slug) }}"
                                class="mr-6 text-[#666ee8] hover:text-[#666ee8]"><i class="ft-edit"></i></a>
                            <button wire:click="$emit('deleteFile',{{ $model->id }})"
